...
public:
	...
	ImageTexture* GetMapKd_of_SubMeshes(int c) { return subMeshes[c].material->GetMapKd(); }
	int GetHaveMapKdValue(int c) { return subMeshes[c].material->GetHaveMapKd(); }
