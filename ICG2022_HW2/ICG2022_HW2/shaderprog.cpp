...
void PhongShadingDemoShaderProg::GetUniformVariableLocation()
{
    ...
    locSpotLightTotalWidth = glGetUniformLocation(shaderProgId, "spotLightCutoffStartInDegree");
    locSpotLightFalloffStart = glGetUniformLocation(shaderProgId, "spotLightTotalWidthInDegree");
